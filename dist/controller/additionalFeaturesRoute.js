...
var additionalFeaturesRoute = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deletedCustomerAccount = _a.sent();
    ...
    ], additionalFeaturesRoute.prototype, "deleteSupplier", null);
    __decorate([
        (0, routing_controllers_1.Delete)('/deleteCustomerAccount/:customer_id'),
        __param(0, (0, routing_controllers_1.Param)("customer_id")),
        __param(1, (0, routing_controllers_1.Res)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, Object]),
        __metadata("design:returntype", Promise)
    ], additionalFeaturesRoute.prototype, "deleteCustomer", null);
    additionalFeaturesRoute = __decorate([
        (0, routing_controllers_1.JsonController)('/additional')
    ], additionalFeaturesRoute);
    return additionalFeaturesRoute;
}());
exports.default = additionalFeaturesRoute;
